...
use MI\PlatformBundle\Entity\Image;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('MIPlatformBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('MI\PlatformBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('MI\PlatformBundle\Form\ImageType', $image);
